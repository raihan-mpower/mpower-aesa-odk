 ...
 * @author carlhartung
 */
public class ODKView2 extends ScrollView implements OnLongClickListener {
    ...
    public LinearLayout questionsholder;
    ...
    public ODKView2(Context context, FormEntryPrompt[] questionPrompts,
        ...
        questionsholder = new LinearLayout(getContext());
        questionsholder.setOrientation(LinearLayout.HORIZONTAL);
        questionsholder.setGravity(Gravity.LEFT);
        questionsholder.setPadding(0, 0, 0, 0);
        // display which group you are in as well as the question
        Log.v("alphachan omega",""+questionPrompts.length);
        addGroupText(groups);
        boolean first = true;
        int id = 0;
...
//                mView.addView(divider);
            ...
            qw.setId(VIEW_ID + id++);
            qw.setBackgroundColor(Color.BLUE);
            widgets.add(qw);
            questionsholder.addView((View) qw, mLayout);
            

        }
        mView.addView(questionsholder);
        mView.setBackgroundColor(Color.MAGENTA);
        addView(mView);
