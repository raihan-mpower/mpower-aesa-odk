    ...
    public DateTimeWidgettext(Context context, FormEntryPrompt prompt) {
                ...
                if (mPrompt.isReadOnly()) {
                    ...
                    if (day > max) {
                        if (! (mDatePicker.getDayOfMonth()==day && mDatePicker.getMonth()==month && mDatePicker.getYear()==year) ) {
                        	Collect.getInstance().getActivityLogger().logInstanceAction(DateTimeWidgettext.this, "onDateChanged",
        ...
        mTimePicker.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
			...
			public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
            	Collect.getInstance().getActivityLogger().logInstanceAction(DateTimeWidgettext.this, "onTimeChanged",
        ...
        timedialog.setOnCancelListener(new OnCancelListener() {
			...
			public void onCancel(DialogInterface dialog) {
				// TODO Auto-generated method stub
				textofwidget.setText(mDatePicker.getDayOfMonth()+"/"+mDatePicker.getMonth()+"/"+mDatePicker.getYear() + " "+mTimePicker.getCurrentHour()+":"+mTimePicker.getCurrentMinute());
//				setAnswer();
			}
		});
    ...
    private void setAnswer() {
        ...
        if (mPrompt.getAnswerValue() != null) {
            ...
            textofwidget.setText(String.valueOf(ldt.getDayOfMonth())+"/"+String.valueOf(ldt.getMonthOfYear() - 1)+"/"+String.valueOf((ldt.getYear())));
        } else {
